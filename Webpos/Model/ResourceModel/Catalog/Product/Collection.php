...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
    ...
    protected function _construct()
    {
        if ($this->isEnabledFlat()) {
            $this->_init('Magestore\Webpos\Model\Repository\Catalog\Product', 'Magento\Catalog\Model\ResourceModel\Product\Flat');
        } else {
            $this->_init('Magestore\Webpos\Model\Repository\Catalog\Product', 'Magento\Catalog\Model\ResourceModel\Product');
        }
        $this->_initTables();
    }
